...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as TeacherActivity).setActionBarTitle("Home")

        val rootView = inflater.inflate(R.layout.fragment_home, container, false)
        recyclerView = rootView.teacher_home_message_rv
    ...
    private fun getMessageData() {
        ...
        ref.child("messages/$userRole")
            .addValueEventListener(object : ValueEventListener {
                ...
                override fun onCancelled(p0: DatabaseError) { Log.d("HomeFragment", "get message data cancelled") }
            })
    }
        ...
        recyclerView.apply {
            ...
            adapter = TeacherMessageAdapter(messageData, object : OnItemClickListener {
                override fun onItemClicked(item: ODMessage) {
                    if (item.user.name != "No Messages") (activity as TeacherActivity).showODMessage(item)
                }
            })
        }
    }
